...
if (isset($_GET['edit'])) {
	if ((isset($_GET['update']) && ($_GET['update'] == true ))) {
		...
		// Etiquette n°1
		if ((isset($etiquette[0]["nom"])) && ($_POST['tag1'] != "")) {
		...
		elseif ($getTag1 == "") {
			$tag1IDActual = select_id_tag($pdo, $etiquette[0]["nom"]);
			delete_tag($pdo, $tag1IDActual[0]["id"], $destination[0]["id"]);
		}
		else {
			$tag1ID = select_id_tag($pdo, $getTag1);
		...
		// Etiquette n°2
		if ((isset($etiquette[1]["nom"])) && ($_POST['tag2'] != "")) {
		...
		elseif ($getTag2 == "") {
			$tag2IDActual = select_id_tag($pdo, $etiquette[0]["nom"]);
			delete_tag($pdo, $tag2IDActual[0]["id"], $destination[0]["id"]);
		}
		else {
			$tag2ID = select_id_tag($pdo, $getTag2);
		...
		// Etiquette n°3
		if ((isset($etiquette[2]["nom"])) && ($_POST['tag3'] != "")) {
		...
		elseif ($getTag3 == "") {
			$tag3IDActual = select_id_tag($pdo, $etiquette[0]["nom"]);
			delete_tag($pdo, $tag3IDActual[0]["id"], $destination[0]["id"]);
		}
		else {
			$tag3ID = select_id_tag($pdo, $getTag3);
